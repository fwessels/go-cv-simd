...
TEXT ·_SimdSse2AbsDifferenceSum(SB), $16-56
...
TEXT ·_SimdSse2AbsDifferenceSumMasked(SB), $40-80
	...
	QUAD $0x5c8b4c1824548b4c; QUAD $0x440824648b4c1024
	QUAD $0x8348f0894824348a
...
TEXT ·_SimdSse2AbsDifferenceSums3x3(SB), $16-56

	MOVQ current+0(FP), DI
	MOVQ currentStride+8(FP), SI
	MOVQ background+16(FP), DX
	MOVQ backgroundStride+24(FP), CX
	MOVQ width+32(FP), R8
	MOVQ height+40(FP), R9
	MOVQ sums+48(FP), R10
	ADDQ $8, SP
...
LBB2_22:
	...
	QUAD $0x894824148b48c101; QUAD $0x0f66c07e0f48660a
	QUAD $0xc17e0f48664ec070; QUAD $0x66084a8948c10148
	QUAD $0xc7700f66f87e0f48; QUAD $0x0148c17e0f48664e
	QUAD $0x0f4866104a8948c1; QUAD $0x664ec6700f66f07e
	QUAD $0x48c10148c17e0f48; QUAD $0xe87e0f4866184a89
	LONG $0xc5700f66; BYTE $0x4e
	JMP  LBB2_42
...
LBB2_41:
	...
	QUAD $0xc7700f66f87e0f48; QUAD $0x0148c17e0f48664e
	QUAD $0x0f4866104a8948c1; QUAD $0x664ec6700f66f07e
	QUAD $0x48c10148c17e0f48; QUAD $0xc07e0f4c66184a89
	LONG $0x700f4166; WORD $0x4ec0
...
TEXT ·_SimdSse2AbsDifferenceSums3x3Masked(SB), $88-80
	...
	QUAD $0x4c8b4c10244c894c; QUAD $0x492824448b483024
...
LBB3_10:
	...
	JE   LBB3_11
	QUAD $0x0f446620247cb60f; QUAD $0xca00380f4566cf6e
...
LBB3_24:
	QUAD $0x0f45663824548b4c
	LONG $0x854dd2ef; BYTE $0xc9
	JE   LBB3_25
	QUAD $0xb60f24047f0f4466; QUAD $0xcf6e0f446620247c
