...
TEXT ·_SimdSse2TextureBoostedSaturatedGradient(SB), 7, $80-80
	...
	QUAD $0x8b48207d8b4c284d; QUAD $0x894c105d8b481855
	QUAD $0xe8394cf0e08348e8; QUAD $0x4489440c244c8944
	WORD $0x0824
	JNE  LBB0_17
	...
	CALL clib·_memset(SB)
	QUAD $0x333c8d4818758b48; QUAD $0x4c28458b48fb894c
	QUAD $0x1024548b48033c8d
	LONG $0x03fa8348
	JB   LBB0_15
...
LBB0_13:
	...
	QUAD $0x0348c3ff4900ff27; QUAD $0x0149284d8b48187d
	LONG $0x5c3b4ccf; WORD $0x1024
	JNE  LBB0_8
	QUAD $0x10458b48c9af0f4c; QUAD $0x8b4cc1014cc18948
	QUAD $0xcf8948cf014d207d
...
LBB0_17:
	...
	QUAD $0xe2894cff894cf631
	CALL clib·_memset(SB)
	QUAD $0x133c8d4818558b48; QUAD $0x071c8d4928458b48
	QUAD $0xf883481024448b48
	BYTE $0x03
	JB   LBB0_26
...
LBB0_24:
	...
	QUAD $0x7d0348c3ff4900ff; QUAD $0xc3014828458b4818
	LONG $0x245c3b4c; BYTE $0x10
	JNE  LBB0_19
	QUAD $0x10458b48c8af0f4c; QUAD $0x8b48c1014cc18948
	QUAD $0xcf8948c8014c2045
...
TEXT ·_SimdSse2TextureBoostedUv(SB), 7, $0-56
	...
	QUAD $0x38245c8b4cd28949; QUAD $0x48f0e08348f08948
	WORD $0xf039
	JNE  LBB1_18
...
TEXT ·_SimdSse2TextureGetDifferenceSum(SB), 7, $0-72
...
LBB2_28:
	QUAD $0x034cc8014df70148; QUAD $0x3949c2ff4940245c
...
LBB2_59:
	QUAD $0x034cc8014df70148; QUAD $0x3949c5ff4940245c
...
LBB2_33:
	...
	LONG $0xc5ff4940; WORD $0x3949; BYTE $0xcd
	JNE  LBB2_19
...
LBB2_68:
	...
	LONG $0x48244c8b; WORD $0x8948; BYTE $0x01
	RET

TEXT ·_SimdSse2TexturePerformCompensation(SB), 7, $128-56
	...
	QUAD $0x8949cc8949ce894d; QUAD $0x10558b4cfd8949f7
	QUAD $0x1024548948c08545
	JE   LBB3_49
	QUAD $0x4cf0e08348f8894c
	WORD $0xf839
	JNE  LBB3_27
...
LBB3_25:
	QUAD $0x4c10558b4cdb014c; QUAD $0xe2394cc2ff48d101
	JNE  LBB3_19
...
LBB3_51:
	...
	QUAD $0xfd014d1024548b48
	LONG $0x1075034c; WORD $0xff49; BYTE $0xcc
	JNE  LBB3_51
	JMP  LBB3_143
...
LBB3_67:
	...
	QUAD $0xdb014cf0115c7f0f; QUAD $0x4cc0ff48104d0348
	WORD $0xe039
	JNE  LBB3_61
	QUAD $0xd6014d18246c034c
	LONG $0x4cdf894d; WORD $0x558b; BYTE $0x10
...
LBB3_107:
	...
	QUAD $0x014cf00f5c7f0f41; QUAD $0xc0ff48107d034cdb
...
LBB3_133:
	...
	QUAD $0x4b10458b4cf01774; QUAD $0xf002448d4840048d
	QUAD $0x448d4a1024448948; QUAD $0x4d1824448948f042
	QUAD $0x4dd1894df0105c8d
	LONG $0x8949e129; BYTE $0xf4
