...
//go:noescape
func _SimdSse2BackgroundInitMask(src unsafe.Pointer, srcStride uint64, width, height uint64, index, value uint8, dst unsafe.Pointer, dstStride uint64)
...
//
func SimdSse2BackgroundAdjustRange(loCount, loValue, hiCount, hiValue View, threshold uint8) {
...
//
func SimdSse2BackgroundAdjustRangeMasked(loCount, loValue, hiCount, hiValue View, threshold uint8, mask View) {
...
//
func SimdSse2BackgroundInitMask(src View, index, value uint8, dst View) {
